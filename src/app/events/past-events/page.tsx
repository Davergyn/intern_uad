...
import { getPastEvents } from "@/lib/supabase-content";
    ...
    <main className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <section className="mx-auto w-full max-w-6xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
        <div className="mb-8 flex flex-col items-start gap-6 rounded-2xl bg-[#e5e7eb] p-6 sm:flex-row sm:p-10">
          ...
          <div>
            <h1 className="text-xl font-extrabold text-[#111827] sm:text-2xl">Past Events</h1>
        ...
        <EventTable events={pastEvents} emptyMessage="Belum ada event yang telah berlangsung." status="done" />
      </section>
