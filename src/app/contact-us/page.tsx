...
export const metadata = {
  ...
  description:
    "Hubungi tim .id Academy – kami siap membantu Anda melalui telepon, email, maupun Instagram @dotidacademy.",
};
      ...
      <section className="relative bg-[#f3f4f6] pt-20 pb-32 lg:pb-36">
        <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col gap-10 lg:flex-row lg:items-start lg:gap-16">
            ...
            {/* ── Right: Monitor image (overlaps downward) ── */}
              ...
              <div className="rounded-2xl border border-gray-100 bg-white p-8 shadow-xl">
                ...
                <div className="mt-8 flex items-center gap-3 rounded-xl bg-[#f9fafb] px-4 py-3">
                  ...
                  <p className="text-xs text-[#6b7280]">
                    Kami siap membantu Senin–Jumat, pukul 08.00–17.00 WIB.
                  </p>
                </div>
              </div>
            </div>

            {/* ── Right: Additional info / spacer on desktop ── */}
