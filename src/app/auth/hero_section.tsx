...
export default function HeroSection() {
      ...
      <div className="relative flex w-full flex-col px-10 py-14 xl:px-14 xl:py-16">
        <div>
          ...
          <p className="mt-7 max-w-xl text-2xl leading-relaxed text-white/95 xl:text-3xl">
            Akses ratusan materi pembelajaran, event eksklusif, dan
            bergabunglah dengan komunitas profesional digital terbesar di
            Indonesia.
          </p>
        </div>
  ...
  <div className="mt-6 flex flex-wrap gap-x-10 gap-y-5">
            <div className="text-center">
              ...
              <p className="mt-2 text-xl font-semibold text-white/95">Peserta Aktif</p>
            </div>
            <div className=" text-center ">
              <p className="text-4xl font-black leading-none">1000+</p>
              <p className="mt-2 text-xl font-semibold text-white/95">Narasumber</p>
            </div>
            <div className="text-center">
              <p className="text-4xl font-black leading-none">4.9/5</p>
              <p className="mt-2 text-xl font-semibold text-white/95">Rating Platform</p>
            </div>
          </div>
        </div>
      </div>
