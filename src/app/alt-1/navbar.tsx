      ...
      <details key={item} className="group relative">
        <summary className="flex cursor-pointer list-none items-center gap-1 transition hover:text-[#d6362f] [&::-webkit-details-marker]:hidden">
          ...
          <span className="text-xs transition group-open:rotate-180">
            ...
            {/* ========= navbar dropdown  =========  */}
        <div className="absolute left-0 top-8 z-20 min-w-[160px] rounded-lg border border-black/10 bg-white p-2 shadow-lg">
          {item === "Events" ? (
            <>
            {/* ========= navbar dropdown "event" =========  */}
              <a href="#" className="block rounded-md px-3 py-2 text-sm transition hover:bg-[#f3f4f6] hover:text-[#d6362f]">menu1</a>
              <a href="#" className="block rounded-md px-3 py-2 text-sm transition hover:bg-[#f3f4f6] hover:text-[#d6362f]">menu2</a>
              <a href="#" className="block rounded-md px-3 py-2 text-sm transition hover:bg-[#f3f4f6] hover:text-[#d6362f]">menu3</a>
            </>
          ) : (
            <>
            {/* ========= navbar dropdown "program" =========  */}
              <a href="#" className="block rounded-md px-3 py-2 text-sm transition hover:bg-[#f3f4f6] hover:text-[#d6362f]">Program 1</a>
              <a href="#" className="block rounded-md px-3 py-2 text-sm transition hover:bg-[#f3f4f6] hover:text-[#d6362f]">Program 2</a>
              <a href="#" className="block rounded-md px-3 py-2 text-sm transition hover:bg-[#f3f4f6] hover:text-[#d6362f]">Program 3</a>
            </>
          )}
        </div>
      </details>
