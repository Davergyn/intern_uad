...
type PastCarouselProps = {
  pastEvents: EventRow[];
};

export default function PastCarousel({ pastEvents }: PastCarouselProps) {
            ...
            return (
              ...
              >
                <div className="relative h-48 w-full bg-slate-100">
                  ...
                  {/* Badge Selesai */}
                  <div className="absolute right-3 top-3 rounded-md bg-[#11b981] px-2.5 py-1 shadow-md">
                    <span className="text-[0.65rem] font-bold uppercase tracking-wider text-white drop-shadow-sm">
                      Selesai
                    </span>
                  </div>
                </div>
