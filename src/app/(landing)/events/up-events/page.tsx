...
// TODO: Implement getUpcomingEvents with server route when ready

export const dynamic = "force-dynamic";

export default async function UpcomingEventsPage() {
  const upcomingEvents = []; // Placeholder: awaiting server route implementation
    ...
    <main className="min-h-screen bg-slate-50 text-slate-900">
      <section className="mx-auto w-full max-w-6xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
        <div className="mb-8 flex flex-col items-start gap-6 rounded-2xl bg-[#e5e7eb] p-6 sm:flex-row sm:p-10">
          ...
          <div>
            ...
            <p className="text-[1rem] text-[#4b5563] sm:text-[1.05rem]">
              A range of upcoming events, online webinars, hands-on workshops,
              and insightful seminars.
            </p>
          </div>
        </div>
        ...
        <EventTable
          ...
          emptyMessage="Belum ada event yang dijadwalkan."
          status="ongoing"
        />
      </section>
      <div className="pb-16" />{" "}
