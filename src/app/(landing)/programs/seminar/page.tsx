...
export const metadata = {
  title: "Seminar – .id Academy",
  description: "Kegiatan edukasi terbuka untuk meningkatkan wawasan masyarakat mengenai teknologi digital, identitas digital, keamanan siber, dan pemanfaatan nama domain .id.",
};

export default async function SeminarPage() {
  // 1. Ambil data program Seminar untuk dimasukkan ke Slider
  const programData = await db
    .select()
    .from(programs)
    .where(
      and(
        eq(programs.kategori, "seminar"),
          ...
          <div className="flex flex-col items-center gap-10 lg:flex-row lg:gap-16">
            ...
            <div className="flex flex-1 flex-col gap-6">
              ...
              <p className="max-w-xl text-lg leading-relaxed text-gray-500">
                Program Seminar .id Academy adalah kegiatan edukasi terbuka untuk meningkatkan wawasan masyarakat mengenai teknologi digital, identitas digital, keamanan siber, dan pemanfaatan nama domain .id.
              </p>
