        ...
        <div className="flex flex-col items-center gap-10 lg:flex-row lg:items-start lg:gap-16">
          ...
          <div className="flex min-w-0 flex-1 flex-col gap-6">
            ...
            <div className="flex flex-col gap-4 text-sm leading-7 text-[#374151] sm:text-base">
              <p>
                Program Kuliah Umum .id Academy adalah kegiatan edukasi terbuka yang diselenggarakan oleh 
                PANDI melalui platform 
                pembelajaran .id Academy, dengan tujuan meningkatkan wawasan dan pemahaman masyarakat 
                mengenai teknologi digital, identitas digital, keamanan siber, serta pemanfaatan nama 
                domain .id dalam berbagai sektor.
              </p>
              <p>
                Kuliah umum ini dirancang untuk menjadi ruang berbagi pengetahuan antara akademisi, praktisi, 
                pelaku industri, dan mahasiswa, sehingga mampu menjembatani teori dengan realitas kebutuhan 
                dunia digital.
              </p>
              <p>
                Kegiatan ini terbuka bagi pelajar, mahasiswa, pelaku UMKM, profesional
                digital, dan masyarakat umum yang ingin memperluas wawasan di bidang
                literasi digital dan identitas online.
              </p>
            </div>
            ...
            <div>
              <p className="mb-3 text-sm font-semibold text-[#111827] sm:text-base">
                Melalui program Seminar, peserta diharapkan dapat:
              </p>
              <ul className="flex flex-col gap-2.5">
                <BulletItem text="Memperluas literasi digital" />
                <BulletItem text="Memahami pentingnya kedaulatan dan keamanan identitas digital." />
                <BulletItem text="Menguasai konsep dasar teknologi dan inovasi digital." />
                <BulletItem text="Serta mampu memanfaatkan domain .id sebagai identitas dan infrastruktur digital yang terpercaya." />
              </ul>
              <br />
              Kegiatan ini menjadi bagian dari inisiatif pembangunan ekosistem digital Indonesia yang berkelanjutan, inklusif, dan berdaya saing global.
            </div>
